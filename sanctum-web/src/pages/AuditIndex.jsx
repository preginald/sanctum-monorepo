      ...
      <div className="bg-slate-900 border border-slate-700 rounded-xl overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-black/20 text-xs uppercase text-slate-400 font-bold tracking-wider">
            <tr>
              <th className="p-4 w-32">Audit ID</th>
              ...
              <tr key={a.id} className="hover:bg-white/5 transition-colors">
                ...
                <td className="p-4 font-bold">
                    <button 
                        ...
                        className="hover:underline hover:text-sanctum-gold"
                    >
                ...
                <td className="p-4">
                  <span className="px-2 py-1 rounded bg-white/10 text-xs uppercase font-bold">{a.status}</span>
                </td>
